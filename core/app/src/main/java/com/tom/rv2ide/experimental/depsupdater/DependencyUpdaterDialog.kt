...
class DependencyUpdaterDialog(
    ...
    private fun showWarningDialog(dependency: Dependency) {
        ...
        tvTitle.text = context.getString(R.string.dep_update_warning)
        tvMessage.text = context.getString(R.string.dep_update_confirm_single, "${dependency.group}:${dependency.name}\n${dependency.currentVersion} → ${dependency.latestVersion}")
    ...
    private fun showWarningDialogForAll(dependencies: List<Dependency>) {
        ...
        tvTitle.text = context.getString(R.string.dep_update_warning)
        tvMessage.text = context.getString(R.string.dep_update_confirm_multi, dependencies.size)
    ...
    private fun showUpdateConfirmDialog(dependency: Dependency) {
        ...
        tvConfirmTitle.text = context.getString(R.string.dep_update_confirm_btn)
        tvConfirmMessage.text = context.getString(R.string.dep_update_confirm_single, "${dependency.group}:${dependency.name}\n${dependency.currentVersion} → ${dependency.latestVersion}")
    ...
    private fun updateDependency(dependency: Dependency) {
        try {
            ...
            tvTitle.text = context.getString(R.string.ok)
            tvMessage.text = context.getString(R.string.dep_update_success, "${dependency.group}:${dependency.name} updated to ${dependency.latestVersion}")
            btnCancel.visibility = View.GONE
            btnUpdate.text = context.getString(R.string.ok)
            ...
            tvMessage.text = context.getString(R.string.dep_update_fail, e.message)
            btnCancel.visibility = View.GONE
            btnUpdate.text = context.getString(R.string.ok)
    ...
    private fun updateAllDependencies(dependencies: List<Dependency>) {
        ...
        lifecycleOwner.lifecycleScope.launch {
            try {
                ...
                tvMessage.text = context.getString(R.string.dep_update_success, "$successCount") + "\n" + context.getString(R.string.dep_update_fail, "$failCount")
                btnCancel.visibility = View.GONE
                btnUpdate.text = context.getString(R.string.ok)
                ...
                tvTitle.text = context.getString(R.string.dep_error)
                tvMessage.text = context.getString(R.string.dep_update_multi_fail, e.message)
                btnCancel.visibility = View.GONE
                btnUpdate.text = context.getString(R.string.ok)
